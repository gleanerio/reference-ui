...
var mytext = getUrlParam('q','Empty');
      ...
      <div>
        <div class="m-2">
          <div class="flex items-center">
            ...
            <div>
              <p>
                <a href="/hagnerd" class="text text-gray-700 text-sm hover:text-black">Source from PROV graph</a>
              </p>
              <a href="/hagnerd/setting-up-tailwind-with-create-react-app-4jd"
                class="text-xs text-gray-600 hover:text-black">
                <time datetime="2019-08-02T13:58:42.196Z">Score: ${s}</time>
              </a>
            </div>
          </div>
        </div>
        <div class="pl-12 md:pl-10 xs:pl-10">
          <h2 class="text-2xl font-bold mb-2 hover:text-blue-600 leading-7">
            <a target="_blank" href="${resurl}" id="article-link-151230">
              Visit Resource
            </a>
          </h2>
