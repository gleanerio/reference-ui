...

{
    ...
    itemClass: '',
    selectTemplate: function (item) {
      return 'source:' + item.original.value;
    },
    menuItemTemplate: function (item) {
      return item.string;
    },
    ...
    lookup: 'key',
    fillAttr: 'value',
    values: [ { key: "Ocean Biological Information System", value: "obis" },
        { key: "Ocean Experts", value: "oceanexperts" },
        { key: "Samples Earth", value: "samplesearth" }],
    loadingItemTemplate: null,
    requireLeadingSpace: true,
    allowSpaces: false,
    replaceTextSuffix: '\n',
